package com.xuncai.parking.common.frame.log;

import com.google.gson.Gson;
import com.xuncai.parking.bean.system.user.vo.UserVO;
import com.xuncai.parking.common.util.ServletUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.xuncai.parking.common.frame.log.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            System.out.println("userName:****"+currentUser.getLoginName());
